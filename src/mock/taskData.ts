...
export const taskData: TaskItem[] = [
  ...
  { id: 'T-014', name: '推进城市更新行动', stage: 'decompose', source: '市政府工作报告第50项', department: '投资处', responsible: '钱处长', deadline: '2025-06-30', progress: 50, status: 'in_progress', priority: 'medium', riskLevel: 'yellow', description: '进度50%，项目开工率不足' },
  { id: 'T-015', name: '非首都功能疏解协调保障', stage: 'process', source: '市政府工作报告第13项', department: '市疏整促专项办', responsible: '郑处长', deadline: '2025-12-31', progress: 45, status: 'in_progress', priority: 'high', riskLevel: 'yellow', description: '进度45%，跨部门协调难度大' },
]
